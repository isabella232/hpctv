    ...
    export default {
        ...
        methods: {
            ...
            makeSprite(cubeNumber, groupName) {
                //create the object
                const spriteMap = new TextureLoader().load(require('@/assets/icon/plus-x-icon.png'));
            ...
            getCanvasHeight() {
                ...
                return this.isMobile ? 225 : (window.innerHeight - 100) * 0.5; // in live-data.scss -- calc(100vh - 170px);
            },
