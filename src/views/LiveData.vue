...
import Three from '../components/graphs/Three';
import LineChart from '../components/graphs/LineChart';
import ThreeModal from '../components/modals-navs/ThreeModal';
      ...
      nowRunning: [
        {
          ...
          iconPath: require('@/assets/icon/projects-icon.svg'),
          statNumber: 0
        },
        {
          statName: 'Active Jobs',
          iconPath: require('@/assets/icon/jobs-icon.svg'),
          statNumber: 0
        }
      ],
      totalRun: [
...
<style src="../assets/scss/live-data.scss" lang="scss"></style>