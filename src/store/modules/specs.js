  ...
  pointsOfInterest: [
    {
      ...
      modalData: {
        ...
        media: require('@/assets/video/specs-videos/spec_heat.mp4')
      }
    },
    {
      x: 22,
      ...
      modalData: {
        ...
        media: require('@/assets/video/specs-videos/spec_transferrate.mp4')
      }
    },
    {
      x: 55,
      ...
      modalData: {
        ...
        media: require('@/assets/video/specs-videos/spec_processing.mp4')
      }
    },
    {
      x: 75,
      ...
      modalData: {
        ...
        media: require('@/assets/video/specs-videos/spec_memory.mp4')
      }
    },
    {
      x: 50,
      ...
      modalData: {
        ...
        media: require('@/assets/video/specs-videos/spec_performance.mp4')
      }
    }
  ],
  glossary: [
