...
1. [Specs](#specs)
    1. [Small Modal](#specs-small-modal)
    1. [Slide up Modal (Glossary)](#specs-glossary)

1. [Live Data](#live-data)
    1. Now Running / Total Run (Stat Cards)
    1. 3D Graph (Three)
    1. Line Graph (Live Chart)
    1. Glosary (Slide Up Modal)

1. Projects
    1. Project Log (Slide Up Modal)
        1. Table (TableComponent)
    1. Individual Project View
        1.  Carousel (Vue Carousel)
